...
- wave `0`: Argo CD exposure, AWS Load Balancer Controller, EBS gp3 StorageClass, External Secrets, Istio base, Jaeger, Kyverno, Metrics Server, NVIDIA Device Plugin, Prometheus stack
- wave `5`: PostgreSQL in `postgres`
- wave `10`: Istiod, dashboard, MLflow, vLLM
- wave `15`: Bifrost, LiteLLM Operator
